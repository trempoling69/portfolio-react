...
import emouLogo from './img/emou.svg';
...
export const projects: Projects = [
  {
    ...
    productDesciption: "Application d'aide à la gestion des émotions.",
    roleDescription: 'Co-fondateur en charge de la partie IT.',
    ability:
      "J'ai pu développer un vrai sens de la vision produit afin de développer une application orienté avant tout sur l'expérience utilisateur. Tout en gardant en vu les contraintes liés à la gestion d'entreprise et à réduire les délais de développement.",
  },
  {
    name: 'MyRed / MyRed Mobile',
    ...
    roleDescription:
      "En charge du maintient, de l'amélioration, du développement et de la conceptions des applications frontend web et mobile. J'ai pu notamment être moteur de la refonte complète de l'application mobile.",
    ability:
      "J'ai pu développer une réelle expertise sur le développement React et mobile ainsi que sur les notions de clean architecture et bonne pratique de développement.",
  },
  {
    ...
    productDesciption:
      "L'application permet à l'exploitation de regrouper et gérer l'ensemble de leur gamme de plantes. Elle offre la possibilité de gérer les plantes en fonction de certaines caractéristiques, de gérer des variantes de production et de gérer les prix de celle-ci. Elle permet également de générer des étiquettes produits en PDF.",
    roleDescription:
      "Chargé de la conception, de l'architecture, du choix technologique ainsi que du développement de l'application, j'ai du concevoir une application adaptée à leur organisation et façon de faire afin d'automatiser et faciliter certains processus.",
    ability:
  ...
  },
  {
    ...
    productDesciption:
      "Application mobile permettant de faciliter l'encaissement des clients, de garder un historique des paniers et de consulter certaines statistiques.",
    roleDescription:
      "Chargé du développement de l'application, j'ai pu mettre en place l'architecture logicielle de celle-ci. En m'appuyant sur les données et ressources récupérées dans l'élaboration d'autres outils pour Rougy Horticulture, j'ai pu développer une application s'intégrant dans leur manière de travailler.",
    ability: "J'ai pu appréhender le développement d'une application mobile avec React Native et expo.",
  },
  {
    name: 'Clique',
    company: 'Akanema',
