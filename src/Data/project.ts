...
export const projects: Projects = [
  ...
  },
  {
    ...
    roleDescription:
      "Actuellement en alternance en tant que développeur frontend, je suis chargé du maintient, de l'amélioration et du développement des applications frontend (web et mobile).",
    ability:
